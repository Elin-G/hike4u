#' hike4u
#'
#' `hike4u_satellite` uses your location, given in longitude and latitude, a given buffer size in meters to find hiking routes close to you. It plots an overview map of the route you have defined by closeness, and saves it to your working directory.
#'
...
#' @return Returns a satellite map in you working directory folder with name: "closest_route_nr_*closeness_value*_satellite_map.png.
#' @examples
#' \dontrun{
#' library(hike4u)
#'
...
hike4u_satellite <- function(longitude, latitude, buffer, closeness_value) {
