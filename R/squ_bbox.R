#' Square BBox
#'
#' `squ_bbox` creates a square bbox around any geometry in a chosen column of an sf dataframe and increases the extent by a chosen amount of meters.
#'
...
#' @return Returns a value of class bbox.
#' @examples
#' \dontrun{
#' library(hike4u)
#'
...
#' bbox <- squ_bbox(final_routes_cl, "closeness", 1, 1000)
#' }
#'
#' @export

squ_bbox <- function(sf_df, column, value, increase) {
  ...
  # Create buffer. Distance is measured in meters (in this case 10km)
