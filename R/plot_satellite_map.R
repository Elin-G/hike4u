#' Plot Satellite Map
#'
#' `plot_satellite_map` plots the satellite map of the chosen, by closeness value, route and exports the map as a PNG file to the working directory.
#'
...
plot_satellite_map <- function(final_routes, poi, ext, closeness_value) {
